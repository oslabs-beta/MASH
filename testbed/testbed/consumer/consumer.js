...
var randomGroupName = function () { return Array(9).fill('a').map(randomLetter).join(''); };
exports.consume = function (socket, topic) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    consumer = kafka.consumer({ groupId: randomGroupName() });
...
exports.consumeAtRate = function (socket, rate, topic) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                ratedConsumer_1 = kafka.consumer({ groupId: randomGroupName() });
